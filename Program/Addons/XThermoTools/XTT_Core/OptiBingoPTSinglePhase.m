function [Res,CompoMod] = OptiBingoPTSinglePhase(X,NORM,LIMS,BinSet,WorkVariXMap,BinPhaseDef)
%
Res = [];
...
%keyboard
[ESP,CompoMod] = Opti_EpsiMinimCalcSinglePhase(WorkVariMod,WorkVariXMap,BinPhaseDef);
